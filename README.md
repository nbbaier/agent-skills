...
### Deprecated
- [npm-supply-chain-security](./skills/npm-supply-chain-security/) (using other methods now)
- [val-town-cli](./skills/val-town-cli/) (superceded by [VT plugin](https://github.com/val-town/plugins))
